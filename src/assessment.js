...
var scopeArray1 = ["grandpa", "dad", "son"];
...
// #7  ###################
// # Implicit binding
// Make a constructor function called burrito. Give it a property called percentLeft and set it equal to 100. 
// Give it another property called eat that is a function. When eat is invoked it uses context to subtract 25 from the percentLeft property on the burrito.
...
// #9  ###################
// # Prototype 2
// Write a constructor function called chimichanga. Give it a property called percentLeft and set it equal to 100. Give it a prototype function called eat. 
// When eat is invoked it uses context to subtract 20 from the percentLeft property on the chimichanga.
...
function subway(personName){
    ...
    return function addIngredient(ingredient){
        personObj.ingredients.push(ingredient);
        return personObj;
    };
}
